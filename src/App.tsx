...
import { ResetPassword } from './components/ResetPassword'; // ➕ Import ResetPassword View
...
function MainAppContent() {
  ...
  // ⚡ INTERCEPT NATIVE PATH ROUTING CHANNELS
  ...
  // If URL matches email recovery links, mount reset page instantly bypassing auth checks
